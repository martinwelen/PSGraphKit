    ...
    Describe 'Get-GkRiskDetection' {
        ...
        BeforeEach {
            ...
            Mock Invoke-GkGraphRequest {
                @(
                    @{ id = 'd1'; detectedDateTime = '2026-07-01T10:00:05Z'; activityDateTime = '2026-07-01T10:00:00Z'; userPrincipalName = 'ada@contoso.com'; riskEventType = 'unfamiliarFeatures'; riskLevel = 'medium'; riskState = 'atRisk'; detectionTimingType = 'realtime'; ipAddress = '1.2.3.4' }
                    @{ id = 'd2'; detectedDateTime = '2026-07-01T11:00:30Z'; activityDateTime = '2026-07-01T11:00:00Z'; userPrincipalName = 'bob@contoso.com'; riskEventType = 'leakedCredentials'; riskLevel = 'high'; riskState = 'confirmedCompromised'; detectionTimingType = 'offline'; ipAddress = '5.6.7.8' }
                )
            }
        }

        It 'emits typed rows and derives DetectedDateTime from detectedDateTime' {
            ...
            ($r | Where-Object Id -eq 'd1').DetectedDateTime | Should -Not -BeNullOrEmpty
        }
